...
import type { NftCollectionMetadata, NftRewardTier } from '$models/nftRewardTier';
...
export type NftRewardsData = {
	...
	CIDs?: string[]; // points to locations of the NFTs' json on IPFS
