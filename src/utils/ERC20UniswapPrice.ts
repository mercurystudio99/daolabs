import { Pool, FACTORY_ADDRESS as UNISWAP_V3_FACTORY_ADDRESS } from '@uniswap/v3-sdk';
import { Token } from '@uniswap/sdk-core';
import IUniswapV3PoolABI from '@uniswap/v3-core/artifacts/contracts/interfaces/IUniswapV3Pool.sol/IUniswapV3Pool.json';
import IUniswapV3FactoryABI from '@uniswap/v3-core/artifacts/contracts/interfaces/IUniswapV3Factory.sol/IUniswapV3Factory.json';
import { constants, type ContractInterface } from 'ethers';
...
export function useUniswapPriceQuery({ tokenSymbol, tokenAddress }: Props) {
	...
	const getPoolAddress = async (
		...
		const poolAddress: string = await readContractByAddress(
	...
	async function getPoolImmutables(address: string, abi: ContractInterface) {
	...
	async function getPoolState(address: string, abi: ContractInterface) {
