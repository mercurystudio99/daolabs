...
export const FUNDING_CYCLE_WARNING_TEXT: () => {
	...
	duration: 'The treasury owner may reconfigure this funding cycle at any time, without notice.',
	ballot:
		'Funding cycles can be reconfigured moments before a new cycle begins, without notifying contributors.',
	allowMinting:
		'The treasury owner may mint any supply of tokens at any time, diluting the token share of all existing contributors.',
	metadataMaxReservedRate:
		'Contributors will not receive any tokens in exchange for contributing to this treasury.',
	metadataReservedRate:
		'Contributors will receive a relatively small portion of tokens in exchange for contributing this treasury.',
});
