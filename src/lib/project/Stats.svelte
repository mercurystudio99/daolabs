...
<section>
	<div class="stats">
		...
		<div class="">
            ...
            funding cycle—any remaining ETH in the Treasury is overflow, until
            the next cycle begins."
				...
				<div slot="right">
					...
					{:else}
						<Popover
							message="The target for this funding cycle is 0, meaning all funds in the Treasury are currently
								...
								<div slot="content">
									...
									{#each gnosisInfo.owners as address}
										<p class="gnosis-address">
											{address}
											<span class="icon" on:click={() => copyToClipboard(address)} on:keydown>
												<Icon name="copy" />
											</span>
										</p>
									{/each}
