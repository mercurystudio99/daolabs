<script lang="ts">
	...
	export let balanceInTargetCurrency: BigNumber | undefined = undefined;
	export let overflowAmountInTargetCurrency: BigNumber | undefined = undefined;

	let percentPaid: number;
