<script lang="ts">
	...
	import { getVideoTokenIdMetadataJson, type OpenseaMetadata } from '$utils/collectionMetadata';
	...
	function changeTokenId(increment: number) {
		...
		metadata = getVideoTokenIdMetadataJson(collection, currentNft, currentCount);
	}
