...
export interface DistributeToPayoutSplitEvent extends BaseEventEntity, BaseProjectEntity {
	domain: BigNumber;
	group: BigNumber;
	amount: BigNumber;
...
export type DistributeToPayoutSplitEventJson = Partial<
	Record<keyof DistributeToPayoutSplitEvent, string> & BaseEventEntityJson & BaseProjectEntityJson
>;
