...
import { parseProjectJson, type Project, type ProjectJson } from './project';
...
export const parseTapEventJson = (json: TapEventJson): Partial<TapEvent> => ({
	...
	fundingCycleId: json.fundingCycleId ? BigNumber.from(json.fundingCycleId) : undefined,
	amount: json.amount ? BigNumber.from(json.amount) : undefined,
	currency: json.currency ? BigNumber.from(json.currency) : undefined,
	netTransferAmount: json.netTransferAmount ? BigNumber.from(json.netTransferAmount) : undefined,
	beneficiaryTransferAmount: json.beneficiaryTransferAmount
		? BigNumber.from(json.beneficiaryTransferAmount)
		: undefined,
	govFeeAmount: json.govFeeAmount ? BigNumber.from(json.govFeeAmount) : undefined,
