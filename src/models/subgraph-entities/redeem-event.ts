...
import { parseProjectJson, type Project } from './project';
...
export const parseRedeemEventJson = (json: RedeemEventJson): Partial<RedeemEvent> => ({
	...json,
	project: json.project ? parseProjectJson(json.project) : undefined,
	amount: json.amount ? BigNumber.from(json.amount) : undefined,
	returnAmount: json.returnAmount ? BigNumber.from(json.returnAmount) : undefined,
