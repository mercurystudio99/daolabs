...
export type ProjectV2 = {
	...
	// NOTE: Temporary fix until we have aligned goerli and mainnet
	pv?: '2';
	cv?: '2';
...
export type TrendingProject = Pick<
	Project,
	'id' | 'projectId' | 'createdAt' | 'totalPaid' | 'metadataUri' | 'handle' | 'platform'
> & {
...
export type TrendingProjectJson = Pick<
	TrendingProject,
	'id' | 'projectId' | 'createdAt' | 'metadataUri' | 'trendingPaymentsCount' | 'handle' | 'platform'
> & {
