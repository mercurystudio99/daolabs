...
export const parseParticipantJson = (json: ParticipantJson): Partial<Participant> => ({
	...json,
	...
	stakedBalance: json.stakedBalance ? BigNumber.from(json.stakedBalance) : undefined,
	unstakedBalance: json.unstakedBalance ? BigNumber.from(json.unstakedBalance) : undefined,
