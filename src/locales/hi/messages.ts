/*eslint-disable*/ export const messages = {
	...
	'<0/> Archived projects have not been modified or deleted on the blockchain, and can still be interacted with directly through the Juicebox contracts.':
		'<0/> Archived projects have not been modified or deleted on the blockchain, and can still be interacted with directly through the Juicebox contracts.',
	'<0/> The Juicebox protocol is open to anyone, and project configurations can vary widely. There are risks associated with interacting with all projects on the protocol. Projects built on the protocol are not endorsed or vetted by JuiceboxDAO. Do your own research and understand the risks before committing your funds.':
		'<0/> The Juicebox protocol is open to anyone, and project configurations can vary widely. There are risks associated with interacting with all projects on the protocol. Projects built on the protocol are not endorsed or vetted by JuiceboxDAO. Do your own research and understand the risks before committing your funds.',
	'<0/> owner balance': '<0/> owner balance',
	'<0/>{0}{1} withdrawn': ['<0/>', ['0'], ['1'], ' withdrawn'],
	...
	'<0>Learn more</0> about funding cycle duration.':
		'<0>Learn more</0> about funding cycle duration.',
	'<0>Learn more</0> about funding cycles.': '<0>Learn more</0> about funding cycles.',
	'<0>Learn more</0> about overflow.': '<0>Learn more</0> about overflow.',
	...
	'<0>Note:</0> These properties will <1>not</1> be editable immediately within a funding cycle. They can only be changed for <2>upcoming</2> funding cycles.':
		'<0>Note:</0> These properties will <1>not</1> be editable immediately within a funding cycle. They can only be changed for <2>upcoming</2> funding cycles.',
	'<0>Note:</0> Tokens cannot be claimed because no ERC20 token has been issued for this project. ERC20 tokens must be issued by the project owner.':
		'<0>Note:</0> Tokens cannot be claimed because no ERC20 token has been issued for this project. ERC20 tokens must be issued by the project owner.',
	'<0>Notice:</0> These balances will not reflect transfers of claimed tokens because the {tokenSymbol} ERC-20 token has not yet been indexed by Juicebox.':
		[
			'<0>Notice:</0> These balances will not reflect transfers of claimed tokens because the ',
			['tokenSymbol'],
			' ERC-20 token has not yet been indexed by Juicebox.',
		],
	...
	'<0>{tokenSymbol} ERC20 address:</0> <1/>': ['<0>', ['tokenSymbol'], ' ERC20 address:</0> <1/>'],
	'@': '@',
	...
	'Add to balance': 'Add to balance',
	'Add token receiver': 'Add token receiver',
	Address: 'Address',
	'Adjust incentives for paying your project.': 'Adjust incentives for paying your project.',
	All: 'All',
	...
	'All {0} will go to the project owner:': ['All ', ['0'], ' will go to the project owner:'],
	"Allocate a portion of your project's reserved tokens to other Ethereum wallets or Juicebox projects.":
		"Allocate a portion of your project's reserved tokens to other Ethereum wallets or Juicebox projects.",
	'Allow minting tokens': 'Allow minting tokens',
	Allowed: 'Allowed',
	'Almost definitely.': 'Almost definitely.',
	Amount: 'Amount',
	...
	"At the start, power over the governance smart contract is held by Juicebox's founding contributors. The intent is to soon transfer the power to a community of token holders.":
		"At the start, power over the governance smart contract is held by Juicebox's founding contributors. The intent is to soon transfer the power to a community of token holders.",
	'Available after fee:': 'Available after fee:',
	...
	'Bonding curve disabled while no funding target is set.':
		'Bonding curve disabled while no funding target is set.',
	'Bonding curve rate': 'Bonding curve rate',
	...
	'Build a community around a project, fund it, and program its spending. Light enough for a group of friends, powerful enough for a global network of anons.':
		'Build a community around a project, fund it, and program its spending. Light enough for a group of friends, powerful enough for a global network of anons.',
	'Built for:': 'Built for:',
	'Burn project tokens': 'Burn project tokens',
	'Burn tokens': 'Burn tokens',
	'Burn {0} {tokensTextShort}': ['Burn ', ['0'], ' ', ['tokensTextShort']],
	'Burn {0} {tokensTextShort} for ETH': ['Burn ', ['0'], ' ', ['tokensTextShort'], ' for ETH'],
	'Burn {tokensText}': ['Burn ', ['tokensText']],
	'Burn {tokensText} for ETH': ['Burn ', ['tokensText'], ' for ETH'],
	...
	"Changes to your project's funding require a community approval period to take effect. Your supporters don't have to trust you—even though they already do.":
		"Changes to your project's funding require a community approval period to take effect. Your supporters don't have to trust you—even though they already do.",
	'Check this to mint {tokenSymbol} ERC20 to your wallet. Leave unchecked to have your token balance tracked by Juicebox, saving gas on this transaction. You can always claim your ERC20 tokens later.':
		[
			'Check this to mint ',
			['tokenSymbol'],
			' ERC20 to your wallet. Leave unchecked to have your token balance tracked by Juicebox, saving gas on this transaction. You can always claim your ERC20 tokens later.',
		],
	'Claim {0} as ERC20': ['Claim ', ['0'], ' as ERC20'],
	'Claiming {tokenSymbol} tokens will convert your {tokenSymbol} balance to ERC20 tokens and mint them to your wallet.':
		[
			'Claiming ',
			['tokenSymbol'],
	...
	'Commit portions of your funds to the people or projects you want to support, or the contributors you want to pay. When you get paid, so do they.':
		'Commit portions of your funds to the people or projects you want to support, or the contributors you want to pay. When you get paid, so do they.',
	'Community funding for people and projects': 'Community funding for people and projects',
	Connect: 'Connect',
	'Contract address: {0}': ['Contract address: ', ['0']],
	...
	'Currently worth: <0><1/>{0}</0>': ['Currently worth: <0><1/>', ['0'], '</0>'],
	'Custom strategy': 'Custom strategy',
	'Cycle #{0}': ['Cycle #', ['0']],
	'Dark theme': 'Dark theme',
	'Date created': 'Date created',
	'Deposit 1 wei to @{handle}': ['Deposit 1 wei to @', ['handle']],
	...
	'Discount rate disabled while funding cycle duration is 0.':
		'Discount rate disabled while funding cycle duration is 0.',
	"Display ERC20 tokens and other Juicebox project tokens that are in this project's owner's wallet.":
		"Display ERC20 tokens and other Juicebox project tokens that are in this project's owner's wallet.",
	...
	'Do I have to make my project open source to use Juicebox as its business model?':
		'Do I have to make my project open source to use Juicebox as its business model?',
	Docs: 'Docs',
	'Documentation on v1.1 contracts': 'Documentation on v1.1 contracts',
	'Does a project benefit from its own overflow?': 'Does a project benefit from its own overflow?',
	Done: 'Done',
	'Download CSV': 'Download CSV',
	'Download CSV of {0} holders': ['Download CSV of ', ['0'], ' holders'],
	...
	Duration: 'Duration',
	ERC20: 'ERC20',
	'ERC20 community tokens': 'ERC20 community tokens',
	'Each project has its own tokens. Everyone who funds a project gets a newly minted supply of tokens in return. Token balances will be tracked by the protocol until ERC-20 tokens are issued by the project owner':
		'Each project has its own tokens. Everyone who funds a project gets a newly minted supply of tokens in return. Token balances will be tracked by the protocol until ERC-20 tokens are issued by the project owner',
	'Edit reserved token allocation': 'Edit reserved token allocation',
	'Edit token allocation': 'Edit token allocation',
	'Edit token receiver': 'Edit token receiver',
	'Edit tracked assets': 'Edit tracked assets',
	Enabled: 'Enabled',
	'Enabling this allows the project owner to manually mint any amount of tokens to any address.':
		'Enabling this allows the project owner to manually mint any amount of tokens to any address.',
	'Enabling tokens to be minted will appear risky to contributors, and should only be used when necessary.':
		'Enabling tokens to be minted will appear risky to contributors, and should only be used when necessary.',
	End: 'End',
	'Ethereum protocols and DAOs': 'Ethereum protocols and DAOs',
	...
	'Funding can be reconfigured at any time. Reconfigurations will start a new funding cycle.':
		'Funding can be reconfigured at any time. Reconfigurations will start a new funding cycle.',
	'Funding cycle': 'Funding cycle',
	'Funding cycle details': 'Funding cycle details',
	'Funding cycle duration': 'Funding cycle duration',
	'Funding cycle target': 'Funding cycle target',
	'Funding cycles can be reconfigured moments before a new cycle begins, without notifying contributors.':
		'Funding cycles can be reconfigured moments before a new cycle begins, without notifying contributors.',
	'Funding distribution': 'Funding distribution',
	'Funds will be distributed to:': 'Funds will be distributed to:',
	'Give feedback': 'Give feedback',
	'Go to Etherscan': 'Go to Etherscan',
	Handle: 'Handle',
	'Heads up': 'Heads up',
	History: 'History',
	Holders: 'Holders',
	'Holding these tokens entitles a project to a portion of its own overflow.':
		'Holding these tokens entitles a project to a portion of its own overflow.',
	Holdings: 'Holdings',
	'How decentralized is Juicebox?': 'How decentralized is Juicebox?',
	'How do I archive a project?': 'How do I archive a project?',
	'How have the contracts been tested?': 'How have the contracts been tested?',
	'How long one funding cycle will last. Funding cycle <0>reconfigurations</0> will only take effect for <1>upcoming</1> funding cycles, i.e. once a current funding cycle has ended.':
		'How long one funding cycle will last. Funding cycle <0>reconfigurations</0> will only take effect for <1>upcoming</1> funding cycles, i.e. once a current funding cycle has ended.',
	'How your project will distribute funds.': 'How your project will distribute funds.',
	'I understand': 'I understand',
	'ID: {0}': ['ID: ', ['0']],
	"If locked, this can't be edited or removed until the lock expires or the funding cycle is reconfigured.":
		"If locked, this can't be edited or removed until the lock expires or the funding cycle is reconfigured.",
	"If you have a project you'd like to archive, let the Juicebox team know in Discord.":
		"If you have a project you'd like to archive, let the Juicebox team know in Discord.",
	...
	"If you're unsure if you need to claim, you probably don't.":
		"If you're unsure if you need to claim, you probably don't.",
	'In Juicebox': 'In Juicebox',
	'In wallet': 'In wallet',
	Incentives: 'Incentives',
	'Indie artists, devs, creators': 'Indie artists, devs, creators',
	'Issue ERC-20 token': 'Issue ERC-20 token',
	"Issue an ERC-20 to be used as this project's token. Once\nissued, anyone can claim their existing token balance in the new token.":
		"Issue an ERC-20 to be used as this project's token. Once\nissued, anyone can claim their existing token balance in the new token.",
	'Issue an ERC-20 token for this project. Once issued, anyone can claim their existing token balance in the new token.':
		'Issue an ERC-20 token for this project. Once issued, anyone can claim their existing token balance in the new token.',
	...
	"It isn't possible to remove a project's data from the blockchain, but we can hide it in the app if you'd like to prevent people from seeing or interacting with it—just let us know in Discord. Keep in mind people will still be able to use your project by interacting directly with the contract.":
		"It isn't possible to remove a project's data from the blockchain, but we can hide it in the app if you'd like to prevent people from seeing or interacting with it—just let us know in Discord. Keep in mind people will still be able to use your project by interacting directly with the contract.",
	"It'd be a lot cooler if you did": "It'd be a lot cooler if you did",
	'JBX Fee ({0}%):': ['JBX Fee (', ['0'], '%):'],
	'Juicebox contracts': 'Juicebox contracts',
	...
	'Juicebox was built to allow people and projects to get paid for creating public art and infrastructure, as much as or more than they would working towards corporate ends. No more shady business.':
		'Juicebox was built to allow people and projects to get paid for creating public art and infrastructure, as much as or more than they would working towards corporate ends. No more shady business.',
	'Last paid': 'Last paid',
	'Last paid timestamp': 'Last paid timestamp',
	Latest: 'Latest',
	...
	MAX: 'MAX',
	Manage: 'Manage',
	'Manage {0}tokens': ['Manage ', ['0'], 'tokens'],
	Memo: 'Memo',
	'Migrate to Juicebox V1.1': 'Migrate to Juicebox V1.1',
	'Mint project tokens on demand': 'Mint project tokens on demand',
	'Mint {0}tokens': ['Mint ', ['0'], 'tokens'],
	"Minting tokens can be enabled or disabled by reconfiguring a v1.1 project's funding cycle. Tokens can only be minted by the project owner.":
		"Minting tokens can be enabled or disabled by reconfiguring a v1.1 project's funding cycle. Tokens can only be minted by the project owner.",
	'More trending projects': 'More trending projects',
	Name: 'Name',
	New: 'New',
	No: 'No',
	'No activity yet': 'No activity yet',
	'No duration set.': 'No duration set.',
	...
	'No more than the funding cycle target can be distributed by the project in a single funding cycle.':
		'No more than the funding cycle target can be distributed by the project in a single funding cycle.',
	'No past funding cycles': 'No past funding cycles',
	...
	'Note: Juicebox is new, unaudited, and not guaranteed to work perfectly. Before spending money, do your own research: <0>ask questions</0>, <1>check out the code</1>, and understand the risks!':
		'Note: Juicebox is new, unaudited, and not guaranteed to work perfectly. Before spending money, do your own research: <0>ask questions</0>, <1>check out the code</1>, and understand the risks!',
	'Notice from {0}:': ['Notice from ', ['0'], ':'],
	'Open source businesses': 'Open source businesses',
	...
	"Overflow is created if your project's balance exceeds your funding cycle target. Overflow can be redeemed by your project's token holders.":
		"Overflow is created if your project's balance exceeds your funding cycle target. Overflow can be redeemed by your project's token holders.",
	'Paid as <0/>': 'Paid as <0/>',
	'Pause payments': 'Pause payments',
	'Pause received payments': 'Pause received payments',
	Paused: 'Paused',
	Pay: 'Pay',
	...
	'Paying this project is currently disabled, because the token reserved rate is 100% and no tokens will be earned by making a payment.':
		'Paying this project is currently disabled, because the token reserved rate is 100% and no tokens will be earned by making a payment.',
	'Paying this project is currently disabled.': 'Paying this project is currently disabled.',
	"Paying {0} is not an investment—it's a way to support the project. Any value or utility of the tokens you receive is determined by {1}.":
		[
			'Paying ',
			['0'],
			" is not an investment—it's a way to support the project. Any value or utility of the tokens you receive is determined by ",
			['1'],
			'.',
		],
	Payments: 'Payments',
	...
	'Payouts (optional)': 'Payouts (optional)',
	...
	'Percentages must add up to 100% or less': 'Percentages must add up to 100% or less',
	Podcast: 'Podcast',
	'Powered by public smart contracts on': 'Powered by public smart contracts on',
	Preview: 'Preview',
	'Programmable spending': 'Programmable spending',
	Project: 'Project',
	'Project Token': 'Project Token',
	'Project description': 'Project description',
	'Project details': 'Project details',
	'Project handle': 'Project handle',
	'Project handle must be unique.': 'Project handle must be unique.',
	'Project name': 'Project name',
	'Project name, handle, links, and other details.':
		'Project name, handle, links, and other details.',
	'Project owner': 'Project owner',
	'Project owner balance': 'Project owner balance',
	Projects: 'Projects',
	'Projects can be created with an optional discount rate to incentivize funding it earlier than later. The amount of tokens rewarded per amount paid to your project will decrease by the discount rate with each new funding cycle. A higher discount rate will incentivize supporters to pay your project earlier than later.':
		'Projects can be created with an optional discount rate to incentivize funding it earlier than later. The amount of tokens rewarded per amount paid to your project will decrease by the discount rate with each new funding cycle. A higher discount rate will incentivize supporters to pay your project earlier than later.',
	'Projects on Juicebox': 'Projects on Juicebox',
	'Projects using Juicebox': 'Projects using Juicebox',
	'Projects using a reserved rate of {reservedRateRiskyMin}% or more will appear risky to contributors, as a relatively small number of tokens will be received in exchange for paying your project.':
		[
			'Projects using a reserved rate of ',
			['reservedRateRiskyMin'],
			'% or more will appear risky to contributors, as a relatively small number of tokens will be received in exchange for paying your project.',
		],
	...
	'Receive ERC20': 'Receive ERC20',
	'Receive {receiveText}': ['Receive ', ['receiveText']],
	Reconfiguration: 'Reconfiguration',
	'Reconfiguration strategy': 'Reconfiguration strategy',
	Reconfigure: 'Reconfigure',
	'Reconfigure funding': 'Reconfigure funding',
	'Reconfigure upcoming': 'Reconfigure upcoming',
	'Reconfigure upcoming funding': 'Reconfigure upcoming funding',
	Redeem: 'Redeem',
	'Redistributable surplus': 'Redistributable surplus',
	'Reserved token allocation (optional)': 'Reserved token allocation (optional)',
	'Reserved token allocations': 'Reserved token allocations',
	'Reserved tokens': 'Reserved tokens',
	'Reserved {0}': ['Reserved ', ['0']],
	Reserves: 'Reserves',
	Resources: 'Resources',
	'Restrict payments and printing tokens.': 'Restrict payments and printing tokens.',
	'Restricted actions': 'Restricted actions',
	'Return my ETH': 'Return my ETH',
	...
	'Save funding configuration': 'Save funding configuration',
	'Save handle': 'Save handle',
	'Save payouts': 'Save payouts',
	'Save project details': 'Save project details',
	'Save reconfiguration': 'Save reconfiguration',
	'Save token allocation': 'Save token allocation',
	'Save token receiver': 'Save token receiver',
	'Save tracked assets': 'Save tracked assets',
	'Search projects by handle': 'Search projects by handle',
	'See transaction': 'See transaction',
	'Set a funding cycle duration': 'Set a funding cycle duration',
	'Set a funding cycle target': 'Set a funding cycle target',
	"Set a funding target to cover predictable expenses. Any extra funds can be claimed by anyone holding your project's tokens alongside you.":
		"Set a funding target to cover predictable expenses. Any extra funds can be claimed by anyone holding your project's tokens alongside you.",
	"Set the amount of funds you'd like to raise each funding cycle. Any funds raised within the funding cycle target can be distributed by the project, and can't be redeemed by your project's token holders.":
		"Set the amount of funds you'd like to raise each funding cycle. Any funds raised within the funding cycle target can be distributed by the project, and can't be redeemed by your project's token holders.",
	'Set the length of your funding cycles.': 'Set the length of your funding cycles.',
	'Should you Juicebox?': 'Should you Juicebox?',
	...
	'Sum of percentages cannot exceed 100%': 'Sum of percentages cannot exceed 100%',
	'Sum of percentages cannot exceed 100%.': 'Sum of percentages cannot exceed 100%.',
	Target: 'Target',
	'Target is 0.': 'Target is 0.',
	...
	'The address that should receive the tokens minted from paying this project.':
		'The address that should receive the tokens minted from paying this project.',
	'The address that should receive the tokens.': 'The address that should receive the tokens.',
	...
	'The founding contributors will then be working on L2 payment terminals for Juicebox projects.':
		'The founding contributors will then be working on L2 payment terminals for Juicebox projects.',
	"The funds available to withdraw for this funding cycle after the {0}% JBX fee is subtracted. This number won't roll over to the next funding cycle, so funds should be withdrawn before it ends.":
		[
	...
	'The percent this individual receives of the overall {reservedRate}% \nreserved token allocation':
		[
			'The percent this individual receives of the overall ',
			['reservedRate'],
			'% \nreserved token allocation',
		],
	...
	'There was also a script written for iteratively running the integration tests using a random input generator, prioritizing edge cases. The code has successfully passed over 1 millions test cases through this stress-testing script.':
		'There was also a script written for iteratively running the integration tests using a random input generator, prioritizing edge cases. The code has successfully passed over 1 millions test cases through this stress-testing script.',
	'These attributes can be changed at any time.': 'These attributes can be changed at any time.',
	...
	'Token redeem value': 'Token redeem value',
	...
	"Tokens can be redeemed for a portion of this project's ETH overflow, according to the bonding curve rate of the current funding cycle. <0>Tokens are burned when they are redeemed.</0>":
		"Tokens can be redeemed for a portion of this project's ETH overflow, according to the bonding curve rate of the current funding cycle. <0>Tokens are burned when they are redeemed.</0>",
	Tools: 'Tools',
	'Total ETH paid': 'Total ETH paid',
	'Total funds:': 'Total funds:',
	'Total raised': 'Total raised',
	'Total supply': 'Total supply',
	'Total: {0}%': ['Total: ', ['0'], '%'],
	'Transfer ownership': 'Transfer ownership',
	'Transfer unclaimed {tokenSymbolText}': ['Transfer unclaimed ', ['tokenSymbolText']],
	'Transfer {tokenSymbolText}': ['Transfer ', ['tokenSymbolText']],
	'Transparency & accountability': 'Transparency & accountability',
	Trending: 'Trending',
	Twitter: 'Twitter',
	Unavailable: 'Unavailable',
	'Unrecognized strategy contract. Make sure this is correct!':
		'Unrecognized strategy contract. Make sure this is correct!',
	...
	Website: 'Website',
	'What are community tokens?': 'What are community tokens?',
	'What are the risks?': 'What are the risks?',
	'What does Juicebox cost?': 'What does Juicebox cost?',
	...
	"When someone pays your project as a patron or a user of your app, they earn a portion of your project's token. When you win, your token holders win, so they'll want you to win even more.":
		"When someone pays your project as a patron or a user of your app, they earn a portion of your project's token. When you win, your token holders win, so they'll want you to win even more.",
	...
	'You can still redeem your {tokenSymbol} tokens for overflow without claiming them, and you can transfer your unclaimed {tokenSymbol} tokens to another address from the Tools menu, which can be accessed from the wrench icon in the upper right hand corner of this project.':
		[
			'You can still redeem your ',
			['tokenSymbol'],
			' tokens for overflow without claiming them, and you can transfer your unclaimed ',
			['tokenSymbol'],
			' tokens to another address from the Tools menu, which can be accessed from the wrench icon in the upper right hand corner of this project.',
		],
	'You have set a funding cycle target.': 'You have set a funding cycle target.',
	'You will receive {0}{1} ETH': ['You will receive ', ['0'], ['1'], ' ETH'],
	...
	"Your project is funded across funding cycles. A funding cycle has a funding target and a duration. Your project's funding cycle configuration will depend on the kind of project you're starting.":
		"Your project is funded across funding cycles. A funding cycle has a funding target and a duration. Your project's funding cycle configuration will depend on the kind of project you're starting.",
	"Your project's Twitter handle.": "Your project's Twitter handle.",
	"Your project's funding cycle target and duration.":
		"Your project's funding cycle target and duration.",
	"Your project's website.": "Your project's website.",
	'after {0}% JBX fee': ['after ', ['0'], '% JBX fee'],
	'are unaudited, and may be vulnerable to bugs or hacks. All funds moved through Juicebox could be lost or stolen. JuiceboxDAO is not liable for any losses by projects or their supporters.':
		'are unaudited, and may be vulnerable to bugs or hacks. All funds moved through Juicebox could be lost or stolen. JuiceboxDAO is not liable for any losses by projects or their supporters.',
	...
	'last {trendingWindowDays} days': ['last ', ['trendingWindowDays'], ' days'],
	'matching "{searchText}"': ['matching "', ['searchText'], '"'],
	...
	token: 'token',
	tokens: 'tokens',
	'tokens redeemed': 'tokens redeemed',
	until: 'until',
	'{0} after JBX fee': [['0'], ' after JBX fee'],
	'{0} ago': [['0'], ' ago'],
	'{0} balance': [['0'], ' balance'],
	'{0} contributed': [['0'], ' contributed'],
	'{0} days': [['0'], ' days'],
	'{0} for you': [['0'], ' for you'],
	'{0} holders': [['0'], ' holders'],
	'{0} left': [['0'], ' left'],
	'{0} received per ETH paid to the treasury. This can change over time according to the discount rate and reserved tokens amount of future funding cycles.':
		[
			['0'],
	...
	'{0} total': [['0'], ' total'],
	'{0} until #{1}': [['0'], ' until #', ['1']],
	'{0} will go to the project owner: <0/>': [['0'], ' will go to the project owner: <0/>'],
	'{0} withdrawn': [['0'], ' withdrawn'],
	'{0} {1} reserved': [['0'], ' ', ['1'], ' reserved'],
	'{0}% of supply': [['0'], '% of supply'],
	'{0}% to <0/>': [['0'], '% to <0/>'],
	'{0}% to {1}': [['0'], '% to ', ['1']],
	'{0}/ETH': [['0'], '/ETH'],
	'{0}/{1} withdrawn': [['0'], '/', ['1'], ' withdrawn'],
	'{0}{1}': [['0'], ['1']],
