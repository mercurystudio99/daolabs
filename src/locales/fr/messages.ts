/*eslint-disable*/ export const messages = {
	'(Optional) Add a memo to this payment on-chain':
		'(Optionnel) Ajouter une note à ce paiement en chaîne',
	...
	'({realTokenAllocationPercent}% of all newly minted tokens).': [
		...
		'% de tous les tokens récemment frappés).',
	],
	'0% fee': '0% de frais',
	'1 year': '1 an',
	'1. Project details': '1. Détails du projet',
	'100% overflow': '100% overflow',
	'2. Funding cycle': '2. Funding cycle',
	'24 hours': '24 heures',
	'3-day delay': '3 jours de délai',
	'3. Review and deploy': '3. Review and deploy',
	'30 days': '30 jours',
	'7 days': '7 jours',
	'7-day delay': '7 jours de délai',
	'90 days': '90 jours',
	'<0/> Archived projects have not been modified or deleted on the blockchain, and can still be interacted with directly through the Juicebox contracts.':
		"<0/> Les projets archivés n'ont pas été modifiés ou supprimés de la blockchain et peuvent toujours être intégrés directement à travers les contrats Juicebox.",
	...
	'<0/>{0}{1} distributed': ['<0/>', ['0'], ['1'], ' distribués'],
	...
	'<0><1>This project has no overflow</1>, so you will not receive any ETH for burning tokens.</0>':
		"<0><1> Ce projet n'a pas d'overflow</1>, donc vous ne recevrez aucun ETH pour avoir brûlé des tokens.</0>",
	'<0>Juicebox contracts</0> are unaudited, and may be vulnerable to bugs or hacks. All funds moved through Juicebox could be lost or stolen. JuiceboxDAO and Peel are not liable for any losses by projects or their supporters.':
		'Les <0>contrats Juicebox</0> ne sont pas audités et peuvent être vulnérables aux bogues ou aux piratages. Tous les fonds transférés via Juicebox pourraient être perdus ou volés. JuiceboxDAO et Peel ne sont pas responsables des pertes des projets ou de leurs financeurs.',
	'<0>Learn more</0> about burning tokens.': '<0>En savoir plus</0> sur la frappe de tokens.',
	'<0>Learn more</0> about funding cycle duration.':
		'<0>En savoir plus</0> sur la durée du cycle de financement.',
	'<0>Learn more</0> about funding cycles.': '<0>En savoir plus</0> sur les cycles de financement.',
	'<0>Learn more</0> about overflow.': "<0>En savoir plus</0> sur l'overflow.",
	'<0>NOTE:</0> This project has a balance of 0. Projects cannot be migrated without a balance. To migrate this project, first pay it or use the button below to deposit 1 wei (0.000000000000000001 or 10<1>-18</1> ETH).':
		'<0>REMARQUE :</0> Ce projet a un solde de 0. Les projets ne peuvent pas migrer sans un solde. Pour migrer ce projet, vous devez le payer ou utiliser le bouton ci-dessous pour verser 1 wei (0.000000000000000001 or 10<1>-18</1> ETH).',
	...
	'<0>Note:</0> These properties will <1>not</1> be editable immediately within a funding cycle. They can only be changed for <2>upcoming</2> funding cycles.':
		'<0>Remarque :</0> Ces propriétés <1>ne</1> seront pas immédiatement éditables dans un cycle de financement. Elles ne peuvent être modifiées que pour les <2>prochains</2> cycles de financement.',
	...
	'<0>Notice:</0> These balances will not reflect transfers of claimed tokens because the {tokenSymbol} ERC-20 token has not yet been indexed by Juicebox.':
		[
			'<0>Remarque :</0> Ces soldes ne représenteront pas les virements des tokens réclamés, car le token ',
			['tokenSymbol'],
			" ERC-20 n'a pas encore été indexé par Juicebox.",
		],
	'<0>Peel</0> is the DAO that manages the juicebox.money frontend interface. You can reach out to Peel either through the <1>Peel Discord</1> or the <2>Juicebox Discord</2>.':
		"<0>Peel</0> c'est la DAO qui gère l'interface principale de juicebox.money. Vous pouvez contacter Peel à travers le <1>Peel Discord</1> ou le <2>Juicebox Discord</2>.",
	...
	'A mechanism like Juicebox where upfront financial commitments should be honored over time is only guaranteed within an ecosystem like Ethereum.':
		"Un mécanisme comme Juicebox où les engagements financiers initiaux doivent être honorés dans le temps n'est garanti que dans un écosystème comme Ethereum.",
	'A project can be archived by its owner from the tools menu on the project page.':
		'Un projet peut être archivé par son propriétaire, dans le menu des outils de la page du projet.',
	'A project can choose to reserve a percentage of tokens for itself. Instead of being distributed to paying users, this percentage of tokens is instead minted for the project.':
		"Un projet peut choisir de réserver un pourcentage de tokens pour soi. À la place d'être distribué pour payer les utilisateurs, ce pourcentage de tokens est frappé pour le projet.",
	...
	"A project's lifetime is defined in funding cycles. If a funding target is set, the project can withdraw no more than the target for the duration of the cycle.":
		"La durée de vie d'un projet est définie en cycles de financement. Si un objectif de financement est fixé, le projet ne peut retirer que la somme définie pour la durée du cycle.",
	'A reconfiguration to an upcoming funding cycle must be submitted at least 3 days before it starts.':
		"Le reparamétrage d'un cycle de financement à venir doit être soumis au moins 3 jours avant son début.",
	'A reconfiguration to an upcoming funding cycle must be submitted at least 7 days before it starts.':
		"Le reparamétrage d'un cycle de financement à venir doit être soumis au moins 7 jours avant son début.",
	...
	"Add funds to this project's balance without minting tokens.":
		'Ajouter des fonds au solde de ce projet sans frapper des tokens.',
	'Add image': 'Ajouter une image',
	'Add payout': 'Add payout',
	'Add split': 'Add split',
	'Add to Balance': 'Ajouter au solde',
	'Add to balance': 'Ajouter au solde',
	'Add token receiver': 'Ajouter un récepteur de token',
	Address: 'Adresse',
	'Address required': 'Address required',
	'Address:': 'Address:',
	'Address: {0}': ['Adresse : ', ['0']],
	'Adjust incentives for paying your project.':
		'Définir des récompenses au paiement de votre projet.',
	All: 'Tout',
	'All assets': 'Tous les actifs',
	'All changes will be applied to the <0>upcoming</0> funding cycle.':
		'Tous les changements seront appliqués au <0>prochain</0> cycle de financement.',
	'All funds can be distributed by the project. The project will have no overflow (the same as setting the target to infinity).':
		"Tous les fonds peuvent être distribués par le projet. Le projet n'aura pas d'overflow (le même que définir un objectif infini).",
	'All projects': 'Tous les projets',
	'All {0} will go to the project owner:': [
		'Tout ',
		['0'],
		' sera destiné au propriétaire du projet :',
	],
	"Allocate a portion of your project's reserved tokens to other Ethereum wallets or Juicebox projects.":
		"Destinez une portion des tokens réservés à votre projet à d'autres portefeuilles Ethereum ou à des projets Juicebox.",
	'Allow minting tokens': 'Permettre la frappe de tokens',
	'Allow token minting': 'Autoriser la frappe de tokens',
	Allowed: 'Autorisé',
	'Almost definitely.': 'Définitivement.',
	Amount: 'Somme',
	'Amount of ERC-20 tokens to claim': 'Amount of ERC-20 tokens to claim',
	'Amount paid': 'Somme payée',
	'Amount to distribute': 'Montant à distribuer',
	...
	'Any reconfiguration to an upcoming funding cycle will take effect once the current cycle ends. A project with no strategy may be vulnerable to being rug-pulled by its owner.':
		"Tout reparamétrage d'un cycle de financement à venir sera effectif une fois que le cycle en cours aura fini.",
	...
	Assets: 'Actifs',
	'Available after fee:': 'Disponible après le frais :',
	'Available funds are distributed according to the payouts below.':
		'Les fonds disponibles sont distribués selon les paiements ci-dessous.',
	'Available:': 'Disponible :',
	'Back to top': 'Haut de page',
	'Balance exceeded': 'Solde dépassé',
	"Balance of the project owner's wallet.": 'Solde du portefeuille du propriétaire du projet.',
	...
	'Big ups to the Ethereum community for crafting the infrastructure and economy to make Juicebox possible.':
		"Bravo à la communauté Ethereum pour avoir créé l'infrastructure et l'économie nécessaires pour rendre Juicebox possible.",
	'Block number': 'Numéro de blocage',
	Blog: 'Blog',
	'Bonding curve rate': 'Taux de la courbe de liaison',
	...
	'Build a community around a project, fund it, and program its spending. Light enough for a group of friends, powerful enough for a global network of anons.':
		"Construisez une communauté autour d'un projet, financez-le et programmez vos dépenses. Assez léger pour un groupe d'amis, assez puissant pour un réseau mondial d'anonymes.",
	'Built for:': 'Construit pour :',
	'Burn project tokens': 'Brûler les tokens du projet',
	"Burn your {tokensLabel}. You won't receive ETH in return because this project has no overflow.":
		[
			'Brûler vos ',
			['tokensLabel'],
			". Vous ne recevrez pas d'ETH en retour car ce projet n'a pas d'overflow.",
		],
	'Burn {0} {tokensTextShort}': ['Brûler ', ['0'], ' ', ['tokensTextShort']],
	'Burn {tokensLabel}': ['Brûler ', ['tokensLabel']],
	'Burn {tokensTextLong}': ['Brûler ', ['tokensTextLong']],
	"By default, all unallocated funds can be distributed to the project owner's wallet.":
		'Par défaut, tous les fonds non assignés peuvent être distribués au portefeuille du propriétaire.',
	...
	"Can I change my project's contract after it's been created?":
		"Puis-je changer mon contrat de projet après l'avoir créé ?",
	'Can I delete a project?': 'Puis-je supprimer un projet ?',
	Cancel: 'Annuler',
	'Cannot redeem tokens for ETH because this project has no overflow.':
		"Il n'est pas possible de récupérer des tokens pour ETH car ce projet n'a pas d'overflow.",
	...
	'Changes to these attributes can be made at any time and will be applied to your project immediately.':
		'Ces attributs peuvent être modifiés à tout moment et les changements seront appliqués immédiatement à votre projet.',
	"Changes to your project's funding configuration require a community-approved period to take effect, which acts as a safeguard against rug pulls. Your supporters don't have to trust you — even though they already do.":
		"Les changements de financement de votre projet demandent une période d'homologation de la communauté pour prendre effet. Vos financeurs n'ont pas besoin de vous faire confiance, même s'ils le font déjà.",
	...
	'Commit portions of your funds to the people or projects you want to support, or the contributors you want to pay. When you get paid, so do they.':
		'Destinez des parties de vos fonds à des personnes ou à des projets que vous voulez soutenir, ou à des contributeurs que vous voulez payer. Lorsque vous êtes payé, eux aussi le seront.',
	'Community funding for people and projects':
		'Financement participatif pour des personnes et des projets',
	...
	"Configure the dynamics of your project's token.":
		"Configure the dynamics of your project's token.",
	'Congrats on creating your project!': 'Félicitations, vous avez créé votre projet !',
	Connect: 'Connectez-vous',
	'Connect wallet to deploy': 'Connectez un portefeuille à déployer',
	'Connect wallet to pay': 'Connectez un portefeuille pour payer',
	'Contract address: {0}': ['Adresse du contrat : ', ['0']],
	'Contributors will not receive any tokens in exchange for paying this project.':
		'Les contributeurs ne recevront aucun token en échange pour avoir payé ce projet.',
	'Contributors will receive a relatively small portion of tokens in exchange for paying this project.':
		'Les contributeurs recevront une petite portion des tokens en échange pour avoir payé ce projet.',
	'Copied!': 'Copié !',
	...
	'Creating a Juicebox project mints you an NFT (ERC-721) representing ownership over it. Whoever owns this NFT can configure the rules of the game and how payouts are distributed.':
		"La création d'un projet Juicebox vous frappe NFT (ERC-721) qui représente la propriété sur le projet. Celui qui possède ce NFT peut choisir la configuration des règles du jeu et comment les paiements sont distribués.",
	Current: 'En cours',
	'Current 3rd Party Exchange Rates': 'Current 3rd Party Exchange Rates',
	'Current owner: {ownerAddress}': ['Current owner: ', ['ownerAddress']],
	'Currently worth: <0><1/>{0}</0>': ['Valeur actuelle : <0><1/>', ['0'], '</0>'],
	'Custom strategy': 'Stratégie personnalisée',
	'Custom token beneficiary': 'Bénéficiaire de token personnalisé',
	'Cycle #{0}': ['Cycle #', ['0']],
	...
	'Deploy project': 'Déployer le projet',
	'Deploy project on {signerNetwork}': ['Déployer le projet sur ', ['signerNetwork']],
	'Deploy project to {0}': ['Deploy project to ', ['0']],
	'Deposit 1 wei to @{handle}': ['Déposez 1 wei pour @', ['handle']],
	'Design your project': 'Créez votre projet',
	Details: 'Détails',
	Disabled: 'Désactivé',
	...
	'Do I have to make my project open source to use Juicebox as its business model?':
		'Dois-je rendre mon projet open source pour utiliser Juicebox comme son modèle économique ?',
	Docs: 'Documents',
	'Documentation on v1.1 contracts': 'Documents dans v1.1 contrats',
	'Does a project benefit from its own overflow?':
		'Un projet est-il bénéficié par son propre overflow ?',
	Done: 'Finalisé',
	'Download CSV': 'Télécharger CSV',
	'Download CSV of payments': 'Télécharger CSV des paiements',
	'Download CSV of project activity': "Télécharger CSV de l'activité de votre projet",
	'Download CSV of {0} holders': ['Télécharger CSV des ', ['0'], ' titulaires'],
	'Due to their public nature, any exploits to the contracts may have irreversible consequences, including loss of funds. Please use Juicebox with caution.':
		'En raison de leur nature publique, toute exploitation des contrats peut avoir des conséquences irréversibles, y compris la perte de fonds. Veuillez utiliser Juicebox avec prudence.',
	Duration: 'Durée',
	'ERC-20 community tokens': 'Tokens ERC20 de la communauté',
	...
	"Each project has its own <0>ERC-20 tokens</0>. Anyone who contributes funds to a project receives that project's tokens in return. Token balances will be tracked by the protocol until ERC-20 tokens are optionally issued by the project owner.":
		"Chaque projet a ses propres <0>tokens ERC-20</0>. Tous ceux qui financent un projet reçoivent en retour les tokens de ce projet. Les soldes de jetons seront suivis par le protocole jusqu'à ce que les jetons ERC-20 soient éventuellement émis par le propriétaire du projet.",
	'Edit existing split': 'Edit existing split',
	'Edit project': 'Modifier le projet',
	'Edit project details': 'Edit project details',
	'Edit reserved token allocation': "Modifier l'allocation des tokens réservés",
	'Edit token allocation': "Modifier l'allocation de token",
	'Edit token receiver': 'Modifier le destinataire de tokens',
	'Edit tracked assets': 'Modifier les actifs suivis',
	...
	'Enabling this allows the project owner to manually mint any amount of tokens to any address.':
		"L'activation de cette option permet au propriétaire du projet de frapper manuellement n'importe quelle quantité de tokens pour n'importe quelle adresse.",
	...
	'Enabling token minting will appear risky to contributors. Only enable this when necessary.':
		'Enabling token minting will appear risky to contributors. Only enable this when necessary.',
	End: 'Fin',
	'Error loading holders': 'Erreur lors du chargement des titulaires',
	'Error loading payments': 'Erreur lors du chargement des paiements',
	'Ethereum protocols and DAOs': 'Protocoles Ethereum et DAOs',
	'Ethereum provides a public environment where internet apps like Juicebox can run in a permission-less, trustless, and unstoppable fashion.':
		"Ethereum fournit un environnement public où les applications Internet telles que Juicebox peuvent s'exécuter sans autorisation, sans confiance et sans arrêt.",
	FAQ: 'FAQ',
	FAQs: 'FAQs',
	'For example, with a bonding curve of 70%, redeeming 10% of the token supply at any given time will claim around 7% of the total overflow.':
		"Par exemple, avec une courbe de liaison de 70%, récupérer 10% de l'offre de tokens à un moment donné demandera environ 7% de l'overflow total.",
	'For more info, check out this <0>short video</0> on bonding curves.':
		"Regardez cette <0>courte vidéo</0> pour plus d'informations sur les courbes de liaison.",
	'For more info, check out this <0>short video</0>.':
		"Regardez cette <0>courte vidéo</0> pour plus d'informations.",
	'For users paying through your app, you should route those funds through the Juicebox smart contracts so they receive tokens in return.':
		'Pour que les utilisateurs payant via votre appli reçoivent des tokens en retour, vous devez envoyer ces fonds à travers les contrats intelligents Juicebox.',
	Funding: 'Funding',
	'Funding Distribution': 'Distribution du financement',
	'Funding cycle': 'Cycle de financement',
	'Funding cycle details': 'Détails du cycle de financement',
	'Funding cycle duration': 'Durée du cycle de financement',
	'Funding cycle target': 'Objectif du cycle de financement',
	...
	'Funding cycles can be reconfigured moments before a new cycle begins, without notifying contributors.':
		'Funding cycles can be reconfigured moments before a new cycle begins, without notifying contributors.',
	'Funding distribution': 'Distribution des fonds',
	'Funding target': 'Objectif de financement',
	'Funds will be distributed to:': 'Les fonds seront distribués à :',
	'Give feedback': 'Donner un feedback',
	'Give us your feedback': 'Donnez-nous votre feedback',
	'Go to Etherscan': 'Allez à Etherscan',
	Handle: 'Identifiant',
	'Heads up': 'Attention',
	History: 'Historique',
	Holders: 'Titulaires',
	'Holding these tokens entitles a project to a portion of its own overflow.':
		'La détention de ces tokens donne droit à un projet à une partie de son propre overflow.',
	Holdings: 'Participations',
	Hours: 'Hours',
	'How decentralized is Juicebox?': 'À quel point Juicebox est-il décentralisé ?',
	"How did we do? We'd love to get your feedback so we can make creating Juicebox projects as juicy as possible!":
		"Comment s'est-il passé ? Nous aimerions avoir votre feedback pour que nous puissions créer des projets Juicebox les plus juteux possible !",
	'How do I archive a project?': 'Comment archiver un projet ?',
	'How do I create a project?': 'Comment créer un projet ?',
	'How have the contracts been tested?': 'Comment les contrats ont été testés ?',
	'How long one funding cycle will last. Funding cycle <0>reconfigurations</0> will only take effect for <1>upcoming</1> funding cycles, i.e. once a current funding cycle has ended.':
		"La durée d'un cycle de financement. Les <0>reparamétrages</0> d'un cycle de financement ne prendront effet qu'aux cycles de financement <1>suivants</1>, i.e. une fois que le cycle de financement en cours aura fini.",
	'How your project will distribute funds.': 'Comment votre projet distribuera les fonds.',
	'However, Juicebox is still experimental software. Although the Juicebox contract team have done their part to shape the smart contracts for public use and have tested the code thoroughly, the risk of exploits is never 0%.':
		"Cependant, Juicebox est encore un logiciel expérimental. Bien que l'équipe des contrats de Juicebox ait fait sa part pour façonner les contrats intelligents à usage public et ait testé le code de manière approfondie, le risque de l'exploit n'est jamais de 0%.",
	...
	"If you know how much your project needs to earn over some period of time to be sustainable, you can set a funding target with that amount. If your project earns more than that, the surplus funds are locked in an overflow pool. Anyone holding your project's tokens can claim a portion of the overflow pool in exchange for redeeming their tokens.":
		"Si vous savez combien votre projet doit gagner sur une certaine période pour être durable, vous pouvez définir ce montant comme objectif de financement. Si votre projet rapporte plus que l'objectif, les fonds excédants sont bloqués dans un pool d'overflow. Toute personne détenant des tokens de votre projet peut réclamer en échange une partie du pool d'overflow pour pouvoir récupérer ses tokens.",
	"If you're interested in creating a project but still confused on how to get started, consider watching this <0>instructional video</0>. Also feel free to reach out in the <1>Juicebox Discord</1> where our team will be happy to help bring your project idea to life!":
		"Si vous souhaitez créer un projet, mais que vous ne savez toujours pas par où commencer, pensez à regarder cette <0>vidéo d'instructions</0>. N'hésitez pas non plus à nous contacter sur le <1>Discord Juicebox</1> où notre équipe sera ravie de vous aider à donner vie à votre idée de projet !",
	"If you're unsure if you need to claim, you probably don't.":
		"Si vous n'êtes pas sûr de pouvoir le réclamer, probablement vous ne pouvez pas.",
	'In Juicebox': 'Dans Juicebox',
	'In wallet': 'Dans le portefeuille',
	Incentives: 'Récompenses',
	'Indie artists, devs, creators': 'Artistes indépendants, devs, créateurs',
	Infinite: 'Infinite',
	...
	'Issue ERC-20 token': 'Émettre un token ERC-20',
	"Issue an ERC-20 to be used as this project's token. Once issued, anyone can claim their existing token balance in the new token.":
		"Émettre un token ERC-20 pour être utilisé comme token de ce projet. Une fois émis, n'importe qui peut réclamer le solde de tokens existant dans le nouveau token.",
	'Issue token': 'Émettre un token',
	...
	'Juicebox has handled tens of thousands of ETH through its protocol, and has so far had 0 security mishaps.':
		"Juicebox a géré des dizaines de milliers d'ETH via son protocole et n'a eu aucun problème de sécurité jusqu'à présent.",
	...
	'Juicebox was built to allow people and projects to get paid for creating public art and infrastructure, as much as or more than they would working towards corporate ends. No more shady business.':
		"Juicebox a été conçu pour permettre aux personnes et aux projets d'être payés pour la création d'art public et d'infrastructures, autant ou plus qu'ils ne le feraient à des fins commerciales. Fini les affaires louches.",
	'Last paid': 'Dernier paiement',
	'Last paid timestamp': 'Ticket daté du dernier paiement',
	Later: 'Later',
	Latest: 'Dernier',
	'Latest Payments': 'Derniers paiements',
	'Light theme': 'Mode clair',
	'Load more': "Télécharger d'avantage",
	'Lock until': "Bloquer jusqu'à",
	'Locked:': 'Locked:',
	Logo: 'Logo',
	MAX: 'MAX',
	Manage: 'Gérer',
	...
	Memo: 'Mémo',
	'Migrate to Juicebox V1.1': 'Migrer vers Juicebox V1.1',
	...
	"Mint new {tokensLabel} into an account. Only a project's owner, a designated operator, or one of its terminal's delegates can mint its tokens.":
		[
			'Frapper un nouveau ',
			['tokensLabel'],
			' dans un compte. Seulement le propriétaire du projet, un opérateur désigné ou un des délégués du terminal peuvent frapper ces tokens.',
		],
	'Mint project tokens on demand': 'Frapper des tokens de projet sur demande',
	'Mint tokens to a custom address.': 'Frapper des tokens vers une adresse personnalisée.',
	'Mint {tokensLabel}': ['Frapper ', ['tokensLabel']],
	'Mint {tokensTokenLower}': ['Mint ', ['tokensTokenLower']],
	Minutes: 'Minutes',
	'More trending projects': 'Plus de projets populaires',
	'Move your {tokensLabel} from the Juicebox contract to your wallet.': [
		'Transférer vos ',
		['tokensLabel'],
		' du contrat Juicebox vers votre portefeuille.',
	],
	'NO LIMIT': 'NO LIMIT',
	Name: 'Nom',
	New: 'Nouveau',
	...
	'No funding target: The project will control how all funds are distributed, and none can be redeemed by token holders.':
		'Aucun objectif de financement : le projet contrôlera la manière dont tous les fonds sont distribués, et rien ne pourra être récupéré par les titulaires de tokens.',
	'No limit': 'No limit',
	...
	'No more than the funding cycle target can be distributed by the project in a single funding cycle.':
		'No more than the funding cycle target can be distributed by the project in a single funding cycle.',
	'No past funding cycles': 'Aucun cycle de financement précédent',
	'No strategy': 'Aucune stratégie',
	'No target': 'Aucun objectif',
	'No target set.': 'Aucun objectif défini.',
	...
	'Note: Juicebox is new, unaudited, and not guaranteed to work perfectly. Before spending money, do your own research: <0>ask questions</0>, <1>check out the code</1>, and understand the risks!':
		"Remarque : Juicebox est nouveau, non audité et il sans garantie de fonctionner parfaitement. Avant de dépenser de l'argent, faites vos propres recherches : <0>posez des questions</0>, <1>consultez le code</1> et comprenez les risques !",
	'Note: Tokens can be minted manually when allowed in the current funding cycle. This can be changed by the project owner for upcoming cycles.':
		'Note: Tokens can be minted manually when allowed in the current funding cycle. This can be changed by the project owner for upcoming cycles.',
	'Notice from {0}:': ['Notification de ', ['0'], ' :'],
	'Open source businesses': 'Affaires open source',
	"Other assets in this project's owner's wallet.":
		'Autres actifs dans le portefeuille du propriétaire de ce projet.',
	"Overflow is created if your project's balance exceeds your funding cycle target. Overflow can be redeemed by your project's token holders.":
		"Un overflow est créé si le solde de votre projet dépasse votre objectif de financement du cycle. L'overflow peut être récupéré par les détenteurs de tokens de votre projet.",
	'Paid as <0/>': 'Payé comme <0/>',
	'Pause payments': 'Suspendre les paiements',
	'Pause received payments': 'Suspendre les paiements reçus',
	Paused: 'Suspendu',
	Pay: 'Payer',
	'Pay amount': 'Payer le montant',
	'Pay button': 'Pay button',
	'Pay button text': 'Pay button text',
	'Pay disclosure': 'Déclaration pour le paiement',
	'Pay {0}': ['Payer ', ['0']],
	Payer: 'Payeur',
	"Paying <0>{0}</0> is not an investment — it's a way to support the project. Any value or utility of the tokens you receive is determined by {1}.":
		[
			'Un paiement <0>',
			['0'],
			"</0> n'est pas un investissement, c'est une façon de soutenir le projet. Toute valeur ou utilité des tokens que vous recevez est déterminée par ",
			['1'],
			'.',
		],
	'Paying this project is currently disabled, because the token reserved rate is 100% and no tokens will be earned by making a payment.':
		'Le paiement de ce projet est actuellement désactivé, car le taux de token réservé est de 100 % et aucun token ne sera gagné en effectuant un paiement.',
	'Paying this project is currently disabled.':
		'Le paiement de ce projet est actuellement désactivé.',
	Payments: 'Paiements',
	'Payments are paused for the current funding cycle.':
		'Les paiements sont suspendus pour le cycle de financement en cours.',
	'Payments paused': 'Paiements suspendus',
	'Payout amount': 'Payout amount',
	'Payout recipients': 'Bénéficiaires du paiement',
	'Payout splits': 'Payout splits',
	"Payout splits can't be scheduled when the distribution limit is Zero.":
		"Payout splits can't be scheduled when the distribution limit is Zero.",
	'Payouts (optional)': 'Paiements (optionnel)',
	...
	"Peach's Juicebox Stand": "Peach's Juicebox Stand",
	Peel: 'Peel',
	'People using Juicebox are interacting with each other through public infrastructure—not a private, profit-seeking corporate service that brokers the exchange.':
		"Les personnes qui utilisent Juicebox interagissent les unes avec les autres via une infrastructure publique, et non pas via un service d'entreprise privé à but lucratif qui négocie l'échange.",
	Percent: 'Percent',
	'Percent allocation': "Pourcentage d'allocation",
	...
	'Percentage this payee will receive of all funds raised.':
		'Percentage this payee will receive of all funds raised.',
	'Percentages must add up to 100% or less': 'Les pourcentages doivent totaliser 100% ou moins',
	'Please contact the Juicebox dev team through our <0>Discord</0> to have your project archived.':
		'Please contact the Juicebox dev team through our <0>Discord</0> to have your project archived.',
	Podcast: 'Podcast',
	'Potential risks': 'Potential risks',
	'Powered by public smart contracts on': 'Propulsé par des contrats intelligents publics sur',
	'Preview:': 'Aperçu :',
	'Programmable spending': 'Dépenses programmables',
	Project: 'Projet',
	'Project ID is a number.': 'Project ID is a number.',
	'Project ID:': 'Project ID:',
	'Project Token': 'Token du projet',
	'Project configuration': 'Paramètres du projet',
	'Project description': 'Description du projet',
	'Project details': 'Détails du projet',
	'Project details reconfigurations will create a separate transaction.':
		'Les modifications des détails du projet créeront une transaction à part.',
	'Project for {ensName} not found': ['Project for ', ['ensName'], ' not found'],
	'Project handle': 'Identifiant du projet',
	'Project handle must be unique.': "L'identifiant du projet doit être unique.",
	'Project name': 'Nom du projet',
	'Project name, handle, links, and other details.':
		'Nom du projet, identifiant, liens et autres détails du projet.',
	...
	'Projects building on Juicebox pay a {JB_FEE}% JBX membership fee from withdrawn funds into the JuiceboxDAO treasury. Projects can then use their JBX to participate in the governance of JuiceboxDAO and its collective treasury, as well as redeem from its growing <0>overflow</0>. The fee is also subject to change via JBX member votes.':
		[
			"Les projets développés sur Juicebox paient des frais d'adhésion JBX ",
			['JB_FEE'],
			' % à partir des fonds retirés dans la trésorerie de JuiceboxDAO. Les projets peuvent ensuite utiliser leur JBX pour participer à la gouvernance de JuiceboxDAO et de sa trésorerie collective, ainsi que pour récupérer de son <0>overflow</0> croissant. Les frais sont également susceptibles de changer via les votes des membres JBX.',
		],
	...
	'Projects on Juicebox': 'Les projets dans Juicebox',
	'Projects using Juicebox': 'Les projets utilisant Juicebox',
	'Projects using a reserved rate of {reservedRateRiskyMin}% or more will appear risky to contributors, as a relatively small number of tokens will be received in exchange for paying your project.':
		[
			'Les projets utilisant un taux réservé de ',
			['reservedRateRiskyMin'],
			'% ou plus sembleront risqués pour les contributeurs, car un nombre relativement faible de tokens sera reçu en échange du financement de votre projet.',
		],
	'Public goods and services': 'Biens et services publics',
	'Rankings based on number of contributions and volume gained in the last {trendingWindow} days. <0>See code</0>':
		[
			'Classements basés sur le nombre de contributions et le volume gagné au cours des derniers ',
			['trendingWindow'],
			' jours. <0>Voir le code</0>',
		],
	'Receive ERC-20': 'Receive ERC-20',
	'Receive {receiveText}': ['Recevoir ', ['receiveText']],
	'Recipients will receive payouts in ETH.': 'Les bénéficiaires recevront les paiements en ETH.',
	Reconfiguration: 'Reparamétrage',
	'Reconfiguration rules': 'Reconfiguration rules',
	'Reconfiguration strategy': 'Stratégie de reparamétrage',
	Reconfigure: 'Reconfigure',
	'Reconfigure funding': 'Reconfigure funding',
	...
	'Reconfigure upcoming': 'Reconfigure upcoming',
	'Reconfigure upcoming funding': 'Modifier les prochains financements',
	...
	"Redeem your {tokensLabel} for a portion of the project's overflow. Any {tokensLabel} you redeem will be burned.":
		[
			'Récupérer vos ',
			['tokensLabel'],
			" d'une portion de l'overflow du projet. Aucun ",
			['tokensLabel'],
			' récupéré sera brûlé.',
		],
	...
	'Redeem {tokensLabel} for ETH': ['Récupérer ', ['tokensLabel'], ' pour ETH'],
	'Redeem {tokensTextLong} for ETH': ['Récupérer ', ['tokensTextLong'], ' pour ETH'],
	'Redemption rate': 'Taux de récupération',
	'Redemption rate: <0>{0}%</0>': ['Redemption rate: <0>', ['0'], '%</0>'],
	'Redistributable surplus': 'Excédent redistribuable',
	Refresh: 'Actualiser',
	Required: 'Demandé',
	'Reserved rate': 'Taux de réservation',
	'Reserved token allocation (optional)': 'Allocation de tokens réservés (optionnel)',
	'Reserved token allocations': 'Allocation de tokens réservés',
	'Reserved tokens': 'Tokens réservés',
	'Reserved {0}': ['Réservés ', ['0']],
	'Reserved {tokenSymbolPlural}': ['Réservé ', ['tokenSymbolPlural']],
	...
	'Reserved {tokensText}': ['Réservés ', ['tokensText']],
	Reserves: 'Réserves',
	Resources: 'Ressources',
	'Restrict how the owner can reconfigure upcoming funding cycles to mitigate abuse of power. <0>Learn more.</0>':
		'Restrict how the owner can reconfigure upcoming funding cycles to mitigate abuse of power. <0>Learn more.</0>',
	'Restrict payments and printing tokens.': "Limiter les paiements et l'impression de tokens.",
	'Restricted actions': 'Actions restreintes',
	'Review & Deploy': 'Réviser et appliquer',
	...
	'Reward specific community members with tokens.':
		'Récompenser des membres spécifiques de la communauté avec des tokens.',
	Rules: 'Règles',
	'Rules for determining how funding cycles can be reconfigured':
		'Règles pour déterminer comment les cycles de financement peuvent être modifiés',
	'Rules for how changes can be made to your project.':
		'Règles sur la façon dont les modifications peuvent être apportées à votre projet.',
	"Rules for how this project's funding cycles can be reconfigured.":
		'Règles pour déterminer comment les cycles de financement peuvent être modifiés.',
	Save: 'Sauvegarder',
	'Save changes': 'Sauvegarder les modifications',
	'Save funding configuration': 'Sauvegarder les paramètres de financement',
	'Save handle': "Sauvegarder l'identifiant",
	'Save payouts': 'Sauvegarder les paiements',
	'Save project details': 'Sauvegarder les détails du projet',
	'Save reconfiguration': 'Sauvegarder les modifications',
	'Save rules': 'Save rules',
	'Save split': 'Save split',
	'Save token allocation': "Sauvegarder l'allocation de token",
	'Save token configuration': 'Save token configuration',
	'Save token receiver': 'Sauvegarder le destinataire de token',
	'Save tracked assets': 'Sauvegarder les actifs suivis',
	'Search projects by handle': 'Rechercher un projet par son identifiant',
	Seconds: 'Seconds',
	'See transaction': 'Voir la transaction',
	'Set a funding cycle duration': 'Définir la durée du cycle de financement',
	'Set a funding cycle target': "Définir l'objectif du cycle de financement",
	...
	"Set the amount of funds you'd like to raise each funding cycle. Any funds raised within the funding cycle target can be distributed by the project, and can't be redeemed by your project's token holders.":
		"Définissez le montant de fonds que vous souhaitez collecter à chaque cycle de financement. Tous les fonds collectés dans le cadre de l'objectif du cycle de financement peuvent être distribués par le projet et ne peuvent pas être récupérés par les titulaires de tokens de votre projet.",
	'Set the length of your funding cycles, which can enable:':
		'Set the length of your funding cycles, which can enable:',
	'Set the length of your funding cycles.': 'Définissez la durée de vos cycles de financement.',
	'Should you Juicebox?': 'Faut-il Juicebox ?',
	...
	'Some funding cycle properties may indicate risk for project contributors.':
		'Certaines propriétés du cycle de financement peuvent indiquer un risque pour les contributeurs du projet.',
	...
	'Sum of percentages cannot exceed 100%': 'La somme des pourcentages ne peut pas dépasser 100%',
	'Sum of percentages cannot exceed 100%.': 'La somme des pourcentages ne peut pas dépasser 100%.',
	Target: 'Objectif',
	'Target is 0: All funds will be considered overflow and can be redeemed by burning project tokens.':
		"L'objectif est de 0 : Tous les fonds seront considérés comme de l'overflow et pourront être récupérés en brûlant les tokens du projet.",
	'Text displayed on your project\'s "pay" button. Leave this blank to use the default.':
		'Texte affiché sur votre bouton "payer". Laissez-le vide pour utiliser le texte par défaut.',
	"That's the plan, but the core Juicebox contracts will first be deployed to Ethereum Mainnet.":
		"C'est le plan, mais les principaux contrats Juicebox seront d'abord développés sur Ethereum Mainnet.",
	'The JBX protocol is unaudited, and projects built on it may be vulnerable to bugs or exploits. Be smart!':
		"Le protocole JBX n'est pas audité et les projets construits dessus peuvent être vulnérables aux bogues ou aux exploits. Soyez intelligent !",
	...
	'The Juicebox protocol is governed by a community of JBX token holders who vote on proposals fortnightly.':
		'Le protocole Juicebox est régi par une communauté de détenteurs de token JBX qui votent les propositions tous les quinze jours.',
	'The address of any smart contract deployed on {signerNetwork} that implements': [
		"L'adresse de tout contrat intelligent déployé sur ",
		['signerNetwork'],
		' qui implémente',
	],
	'The address that should receive the tokens minted from paying this project.':
		"L'adresse qui doit recevoir les tokens émis pour le paiement de ce projet.",
	...
	'The balance of this project in the Juicebox contract.':
		'Le solde de ce projet dans le contrat Juicebox.',
	...
	'The contract team will soon start working on L2 payment terminals for Juicebox projects.':
		"L'équipe du contrat commencera bientôt à travailler sur les terminaux de paiement L2 pour les projets Juicebox.",
	...
	'The percent this individual receives of the overall {reservedRate}% reserved token allocation': [
		"Le pourcentage que cet individu reçoit de l'allocation globale ",
		['reservedRate'],
		' % de tokens réservés',
	],
	'The project owner may mint any supply of tokens at any time, diluting the token share of all existing contributors.':
		"Le propriétaire du projet peut frapper n'importe quelle offre de tokens à tout moment, diluant la part de tokens de tous les contributeurs existants.",
	'The project owner may reconfigure this funding cycle at any time, without notice.':
		'Le propriétaire du projet peut modifier les paramètres de ce cycle de financement à tout moment, sans préavis.',
	...
	'The total amount received by this project through Juicebox since it was created.':
		'Le montant total reçu par ce projet via Juicebox depuis sa création.',
	...
	'There was also a script written to iteratively run the integration tests using a random input generator, prioritizing edge cases. The code has successfully passed over 1 million test cases through this stress-testing script.':
		"Un script a également été écrit pour exécuter de manière itérative les tests d'intégration à l'aide d'un générateur d'entrées aléatoires, en donnant la priorité aux cas extrêmes. Le code a passé avec succès plus d'un million de cas de test via ce script de test de résistance.",
	'These attributes can be changed at any time.':
		'Ces attributs peuvent être modifiés à tout moment.',
	'These settings will <0>not</0> be editable immediately within a funding cycle. They can only be changed for <1>upcoming</1> funding cycles.':
		"Ces paramètres<0> ne seront pas</0> modifiables immédiatement au cours d'un cycle de financement. Ils ne peuvent être modifiés que pour les cycles de financement <1>à venir</1>.",
	'This address is an unrecognized strategy contract. Make sure it is correct!':
		"Cette adresse est un contrat stratégique non reconnu. Assurez-vous qu'il est correct !",
	'This address will receive any tokens minted when the recipient project gets paid.':
		'Cette adresse recevra tous les tokens frappés lorsque le projet bénéficiaire sera payé.',
	...
	'This funding cycle may pose risks to contributors. Check the funding cycle details before paying this project.':
		'Ce cycle de financement peut présenter des risques pour les contributeurs. Vérifiez les détails du cycle de financement avant de payer ce projet.',
	'This list is using an experimental data index and may be inaccurate for some projects.':
		'Cette liste utilise un index de données expérimental et peut être inexacte pour certains projets.',
	"This means that anyone can see the code that they're using, anyone can use the code without asking for permission, and no one can mess with the code or take it down.":
		"Cela signifie que n'importe qui peut voir le code qu'ils utilisent, n'importe qui peut utiliser le code sans demander la permission, et personne ne peut modifier le code ou le supprimer.",
	'This project has been archived and cannot be paid.':
		'Ce projet a été archivé et ne peut pas être payé.',
	'This project is currently using the Juicebox V1 terminal contract. New features introduced in V1.1 allow the project owner to:':
		'Ce projet utilise actuellement le contrat de terminal Juicebox V1. Les nouvelles fonctionnalités introduites dans V1.1 permettent au propriétaire du projet de :',
	'This project uses the V2 version of the Juicebox contracts.':
		'Ce projet utilise la version V2 des contrats Juicebox.',
	...
	'This text will be displayed to your supporters before they complete their payment.':
		"Ce texte sera affiché à vos financeurs avant qu'ils n'effectuent leur paiement.",
	"This website (juicebox.money) connects to the Juicebox protocol's smart contracts, deployed on the Ethereum network. (note: anyone else can make a website that also connects to these same smart contracts. For now, don't trust any site other than this one to access the Juicebox protocol).":
		"This website (juicebox.money) connects to the Juicebox protocol's smart contracts, deployed on the Ethereum network. (note: anyone else can make a website that also connects to these same smart contracts. For now, don't trust any site other than this one to access the Juicebox protocol).",
	'This will erase all of your changes.': 'Cela effacera toutes vos modifications.',
	'To: <0/>': 'À : <0/>',
	Token: 'Token',
	'Token address: <0/>': 'Adresse du token : <0/>',
	'Token beneficiary address': 'Token beneficiary address',
	'Token beneficiary:': 'Token beneficiary:',
	'Token minting': 'Frappe de tokens',
	...
	'Token redeem value': "Valeur d'échange du token",
	...
	'Tokens are earned by anyone who pays your project, and can be redeemed for overflow if your project has set a funding target.':
		"Les tokens sont gagnés par toute personne qui paie votre projet et peuvent être récupérés de l'overflow si votre projet a défini un objectif de financement.",
	...
	"Tokens can be redeemed for a portion of this project's ETH overflow, according to the bonding curve rate of the current funding cycle. <0>Tokens are burned when they are redeemed.</0>":
		"Les tokens peuvent être récupérés d'une partie de l'overflow d'ETH de ce projet, selon le taux de la courbe de liaison du cycle de financement en cours. <0>Les tokens sont brûlés lorsqu'ils sont récupérés.</0>",
	...
	'Tokens:': 'Tokens :',
	Tools: 'Outils',
	'Total ETH paid': 'Total ETH payé',
	'Total funds:': 'Total de fonds :',
	...
	'Transfer {tokenSymbolShort}': ['Transférer ', ['tokenSymbolShort']],
	'Transparency & accountability': 'Transparence et responsabilité',
	Trending: 'Tendance',
	Twitter: 'Twitter',
	...
	'Updates you make to this section will only be applied to <0>upcoming</0> funding cycles.':
		'Updates you make to this section will only be applied to <0>upcoming</0> funding cycles.',
	Upload: 'Importer',
	'Uploaded to: <0>{url}</0>': ['Uploaded to: <0>', ['url'], '</0>'],
	...
	Website: 'Website',
	'What are community tokens?': 'Que sont les tokens de la communauté ?',
	'What are the risks?': 'Quels sont les risques ?',
	'What does Juicebox cost?': 'Combien coûte Juicebox ?',
	'What is overflow?': "Qu'est-ce que l'oveflow ?",
	"What's a bonding curve?": "What's a bonding curve?",
	"What's a discount rate?": "What's a discount rate?",
	"What's going on under the hood?": 'Que se passe-t-il sous le capot ?',
	...
	'Whenever someone pays your project, this percentage of tokens will be reserved and the rest will go to the payer. Reserve tokens are reserved for the project owner by default, but can also be allocated to other wallet addresses by the owner. Once tokens are reserved, anyone can "mint" them, which distributes them to their intended receivers.':
		'Whenever someone pays your project, this percentage of tokens will be reserved and the rest will go to the payer. Reserve tokens are reserved for the project owner by default, but can also be allocated to other wallet addresses by the owner. Once tokens are reserved, anyone can "mint" them, which distributes them to their intended receivers.',
	'Who funds Juicebox projects?': 'Qui finance les projets Juicebox ?',
	'Who is Peel?': 'Who is Peel?',
	'Why Ethereum?': 'Pourquoi Ethereum ?',
	"Why should I want to own a project's tokens?": "Why should I want to own a project's tokens?",
	'Will be rounded to <0/>{0}': ['Will be rounded to <0/>', ['0']],
	'Will it work on L2s?': 'Cela fonctionnera-t-il sur les L2s ?',
	'With Juicebox, projects are built and maintained by motivated punks getting paid transparently, and funded by a community of users and patrons who are rewarded as the projects they support succeed.':
		"Avec Juicebox, les projets sont construits et maintenus par des punks motivés qui sont payés de manière transparente et financés par une communauté d'utilisateurs et de mécènes qui sont récompensés au fur et à mesure que les projets qu'ils soutiennent réussissent.",
	...
	'You can still redeem your {tokenSymbol} tokens for overflow without claiming them, and you can transfer your unclaimed {tokenSymbol} tokens to another address from the Tools menu, which can be accessed from the wrench icon in the upper right hand corner of this project.':
		[
			'Vous pouvez toujours récupérer vos tokens ',
			['tokenSymbol'],
			" de l'overflow sans les réclamer, et vous pouvez transférer vos tokens ",
			['tokenSymbol'],
			" non réclamés vers une autre adresse à partir du menu Outils, accessible à partir de l'icône en forme de clé anglaise dans le coin supérieur droit de ce projet. .",
		],
	'You have set a funding cycle target.': 'Vous avez défini un objectif du cycle de financement.',
	'You will receive minimum {minReturnedTokensFormatted} ETH': [
		'You will receive minimum ',
		['minReturnedTokensFormatted'],
		' ETH',
	],
	'You will receive {0}{1} ETH': ['Vous recevrez ', ['0'], ['1'], ' ETH'],
	...
	'Your balance: {0}': ['Votre solde : ', ['0']],
	'Your feedback will be sent to a <0>public Discord channel </0>for our development team to consider.':
		'Vos commentaires seront envoyés à une <0>chaîne Discord public </0>pour que notre équipe de développement les examine.',
	'Your project cannot receive direct payments while paused.':
		"Votre projet ne peut pas recevoir de paiements directs lorsqu'il est en pause.",
	"Your project is funded across funding cycles. A funding cycle has a funding target and a duration. Your project's funding cycle configuration will depend on the kind of project you're starting.":
		'Votre projet est financé sur plusieurs cycles de financement. Un cycle de financement a un objectif de financement et une durée. La configuration du cycle de financement de votre projet dépendra du type de projet que vous démarrez.',
	'Your project will appear archived, and will not be able to receive payments through the juicebox.money app. You can unarchive a project at any time. Please allow a few days for your project to appear under the "archived" filter on the Projects page.':
		'Votre projet apparaîtra archivé et ne pourra pas recevoir de paiements via l\'application juicebox.money. Vous pouvez désarchiver un projet à tout moment. Veuillez patienter quelques jours pour que votre projet apparaisse sous le filtre "archivé" sur la page Projets.',
	...
	'Your project will immediately appear active on the juicebox.money app. Please allow a few days for it to appear in the "active" projects list on the Projects page.':
		'Votre projet apparaîtra immédiatement actif sur l\'application juicebox.money. Veuillez patienter quelques jours pour qu\'il apparaisse dans la liste des projets "actifs" sur la page Projets.',
	'Your project will still be able to receive payments directly through the Juicebox protocol contracts.':
		'Votre projet pourra toujours recevoir des paiements directement via les contrats du protocole Juicebox.',
	"Your project's Twitter handle.": 'Identifiant Twitter de votre projet.',
	"Your project's funding cycle target and duration.":
		'Objectif et durée du cycle de financement de votre projet.',
	"Your project's website.": 'Site web de votre projet.',
	...
	token: 'token',
	tokens: 'tokens',
	'tokens redeemed': 'tokens récupérés',
	until: "jusqu'à",
	'{0} after JBX fee': [['0'], ' après les frais JBX'],
	'{0} ago': ['il y a ', ['0']],
	...
	'{0} contributed': [['0'], ' contribué'],
	'{0} days': [['0'], ' jours'],
	'{0} for you': [['0'], ' pour vous'],
	'{0} holders': [['0'], ' titulaires'],
	'{0} reserved': [['0'], ' réservé'],
	'{0} staked': [['0'], ' jalonné'],
	'{0} total': [['0'], ' total'],
	'{0} will go to the project owner: <0/>': [['0'], ' ira au propriétaire du projet : <0/>'],
	'{0} withdrawn': [['0'], ' retiré'],
	'{0} {1} reserved': [['0'], ' ', ['1'], ' réservé'],
	'{0}% of supply': [['0'], "% de l'offre"],
	'{0}% to <0/>': [['0'], '% à <0/>'],
	'{0}% to {1}': [['0'], '% à ', ['1']],
	'{0}/{1} withdrawn': [['0'], '/', ['1'], ' retiré'],
	'{0}{1}': [['0'], ['1']],
	'{count} total': [['count'], ' total'],
	'{exchangeName} has no market for {tokenSymbol}.': [
		['exchangeName'],
		" n'a pas de marché pour ",
		['tokenSymbol'],
		'.',
	],
	'{formattedTimeLeft} left': [['formattedTimeLeft'], ' restant'],
	'{formattedTimeLeft} until #{0}': [['formattedTimeLeft'], " jusqu'à #", ['0']],
	'{handle} not found': [['handle'], ' introuvable'],
	'{handle} will be available soon! Try refreshing the page shortly.': [
		['handle'],
		" sera disponible bientôt ! Essayez d'actualiser la page sous peu.",
	],
	'{label}': [['label']],
	...
	'{paymentCount, plural, one {# payment} other {# payments}}': [
		['paymentCount', 'plural', { one: ['#', ' paiement'], other: ['#', ' paiements'] }],
	],
	'{tokenSymbolPlural} received per ETH paid to the treasury. This can change over time according to the discount rate and reserved tokens amount of future funding cycles.':
		[
			['tokenSymbolPlural'],
			' reçus par ETH versés à la trésorerie. Cela peut changer au fil du temps en fonction du taux de remise et de la quantité de tokens réservés des cycles de financement à venir.',
		],
	...
	'{tokensText} reserved': [['tokensText'], ' réservés'],
