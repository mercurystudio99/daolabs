...
!(function (t, e) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		? define(e)
		: ((t = 'undefined' != typeof globalThis ? globalThis : t || self).introJs = e());
})(this, function () {
	'use strict';
	function t() {
	...
	function b(t, e, n) {
		...
		if (
			...
			((r = 'tooltip' === t ? n.getBoundingClientRect() : o.getBoundingClientRect()),
			!(function (t) {
	...
	function v(t, e) {
		...
		return ('body' !== e.tagName.toLowerCase() && 'relative' === c) || 'sticky' === c
			...
			var e = se.CONFIGURABLE,
				...
				s = (t.exports = function (t, r, s) {
					'Symbol(' === String(r).slice(0, 7) &&
						...
						i && s && Ct(s, 'arity') && t.length !== s.arity && o(t, 'length', { value: s.arity });
					try {
	...
	var En,
		...
		In =
			...
			function (t, e) {
				...
				return (
					null !== t
						? ((Sn.prototype = Kt(t)), (n = new Sn()), (Sn.prototype = null), (n[kn] = t))
						: (n = An()),
					void 0 === e ? n : xn.f(n, e)
				);
			},
	...
	function xr(t) {
		if (t) {
			...
			g(e.element) ? u(t, 'introjs-fixedTooltip') : yr(t, 'introjs-fixedTooltip'),
			...
			return [
				...
				function (t, o) {
					...
					for (var f, d = '', b = 0, m = 0; m < h.length; m++) {
						for (
							var g = fn((p = h[m])[0]), v = hr(pr(Te(p.index), a.length), 0), y = [], w = 1;
							w < p.length;
							w++
						)
									...
									if (
										...
										null !== i && null !== a
											? ((d = a.querySelector('.introjs-helperNumberLayer')),
											  ...
											  xr.call(o, a),
											  Tr(),
											  o._lastShowElementTimer && window.clearTimeout(o._lastShowElementTimer),
											...
											: ((x = Or('div', { className: s })),
											  ...
											  this._options.dontShowAgain &&
													((N = Or('div', { className: 'introjs-dontShowAgain' })),
													((I = Or('input', {
														type: 'checkbox',
													...
													((L = Or('label', { htmlFor: 'introjs-dontShowAgain' })).innerText =
										...
										(O = o._targetElement.querySelector('.introjs-disableInteraction')) &&
											...
											void 0 !== this._currentStepNumber &&
												c(this._introItems, function (t, e) {
													t.step === o._currentStepNumber &&
														((o._currentStep = e - 1), (o._currentStepNumber = void 0));
												}),
						...
						for (;;)
							switch ((t.prev = t.next)) {
								...
								case 24:
									...
									return (
										(t.next = 28), this._introCompleteCallback.call(this, this._currentStep, 'skip')
									);
								case 28:
	...
	function eo(t) {
		...
		var n = {};
		for (var r in t)
			void 0 !== window.jQuery && t[r] instanceof window.jQuery ? (n[r] = t[r]) : (n[r] = eo(t[r]));
		return n;
	}
	function no(t, e) {
		var n,
							...
							switch ((t.prev = t.next)) {
								...
								case 9:
									this._options.hintAutoRefreshInterval >= 0 &&
										...
										l.on(window, 'scroll', this._hintsAutoRefreshFunction, this, !0));
								case 10:
								case 'end':
									return t.stop();
							}
					...
					function (t) {
						for (;;)
							switch ((t.prev = t.next)) {
								case 0:
									if (
										((r = document.querySelector('.introjs-hint[data-step="'.concat(n, '"]'))),
								...
								case 0:
									...
									c(this._options.hints, function (t) {
										...
										'string' == typeof e.element && (e.element = document.querySelector(e.element)),
											(e.hintPosition = e.hintPosition || o._options.hintPosition),
											(e.hintAnimation = e.hintAnimation || o._options.hintAnimation),
									...
									c(r, function (t) {
										...
										(e = e ? 'true' === e : o._options.hintAnimation),
											o._introItems.push({
												...
												hintPosition:
													t.getAttribute('data-hint-position') || o._options.hintPosition,
												hintAnimation: e,
	...
	function _o(t) {
		...
		if (this._options.steps)
			...
			c(n, function (t) {
				if (
					(!e._options.group || t.getAttribute('data-intro-group') === e._options.group) &&
					...
					function (t) {
						for (;;)
							switch ((t.prev = t.next)) {
								...
								case 12:
									this._options.keyboardNavigation && l.on(window, 'keydown', Zr, this, !0),
	...
	function Po(t) {
		t
			? Lo(this._options.dontShowAgainCookie, Oo, this._options.dontShowAgainCookieDays)
		...
		(Bo.fn = qo.prototype =
			{
				...
				addStep: function (t) {
					return (
						this._options.steps || (this._options.steps = []), this._options.steps.push(t), this
					);
				},
				addSteps: function (t) {
					if (t.length) {
