...
const SV_INIT_FLAG_USER_AUDIO_CALLBACK =
...
function sv_get_sample_rate() {
	return svlib._sv_get_sample_rate();
}
function sv_update_input() {
...
function sv_open_slot(slot) {
	return svlib._sv_open_slot(slot);
}
function sv_close_slot(slot) {
	return svlib._sv_close_slot(slot);
}
function sv_lock_slot(slot) {
	return svlib._sv_lock_slot(slot);
}
function sv_unlock_slot(slot) {
	return svlib._sv_unlock_slot(slot);
}
function sv_load_from_memory(slot, byte_array) {
...
function sv_play(slot) {
	return svlib._sv_play(slot);
}
function sv_play_from_beginning(slot) {
	return svlib._sv_play_from_beginning(slot);
}
function sv_stop(slot) {
	return svlib._sv_stop(slot);
}
function sv_pause(slot) {
	return svlib._sv_pause(slot);
}
function sv_resume(slot) {
	return svlib._sv_resume(slot);
}
function sv_sync_resume(slot) {
	return svlib._sv_sync_resume(slot);
}
function sv_set_autostop(slot, autostop) {
	return svlib._sv_set_autostop(slot, autostop);
}
function sv_get_autostop(slot) {
	return svlib._sv_get_autostop(slot);
}
function sv_end_of_song(slot) {
	return svlib._sv_end_of_song(slot);
}
function sv_rewind(slot, line_num) {
	return svlib._sv_rewind(slot, line_num);
}
function sv_volume(slot, vol) {
	return svlib._sv_volume(slot, vol);
}
function sv_set_event_t(slot, set, t) {
	return svlib._sv_set_event_t(slot, set, t);
}
function sv_send_event(slot, track, note, vel, module, ctl, ctl_val) {
	return svlib._sv_send_event(slot, track, note, vel, module, ctl, ctl_val);
}
function sv_get_current_line(slot) {
	return svlib._sv_get_current_line(slot);
}
function sv_get_current_line2(slot) {
	return svlib._sv_get_current_line2(slot);
}
function sv_get_current_signal_level(slot, channel) {
	return svlib._sv_get_current_signal_level(slot, channel);
}
function sv_get_song_name(slot) {
	return svlib.UTF8ToString(svlib._sv_get_song_name(slot));
}
function sv_get_song_bpm(slot) {
	return svlib._sv_get_song_bpm(slot);
}
function sv_get_song_tpl(slot) {
	return svlib._sv_get_song_tpl(slot);
}
function sv_get_song_length_frames(slot) {
	return svlib._sv_get_song_length_frames(slot);
}
function sv_get_song_length_lines(slot) {
	return svlib._sv_get_song_length_lines(slot);
}
function sv_get_time_map(slot, start_line, len, dest_buf_uint32, flags) {
...
function sv_new_module(slot, type, name, x, y, z) {
	//USE LOCK/UNLOCK!
...
function sv_remove_module(slot, mod_num) {
	return svlib._sv_remove_module(slot, mod_num);
} //USE LOCK/UNLOCK!
function sv_connect_module(slot, source, destination) {
	return svlib._sv_connect_module(slot, source, destination);
} //USE LOCK/UNLOCK!
function sv_disconnect_module(slot, source, destination) {
	return svlib._sv_disconnect_module(slot, source, destination);
} //USE LOCK/UNLOCK!
function sv_load_module_from_memory(slot, byte_array, x, y, z) {
	//load from Uint8Array
	var mptr = svlib.allocate(byte_array, 'i8', svlib.ALLOC_NORMAL);
	if (mptr == 0) return -1;
...
function sv_sampler_load_from_memory(slot, sampler_module, byte_array, sample_slot) {
	//load from Uint8Array
	var mptr = svlib.allocate(byte_array, 'i8', svlib.ALLOC_NORMAL);
	if (mptr == 0) return -1;
...
function sv_get_number_of_modules(slot) {
...
function sv_get_module_flags(slot, mod_num) {
	return svlib._sv_get_module_flags(slot, mod_num);
}
function sv_get_module_inputs(slot, mod_num) {
...
function sv_get_module_outputs(slot, mod_num) {
	//return value: Int32Array
	var rv = null;
	var flags = sv_get_module_flags(slot, mod_num);
...
function sv_get_module_name(slot, mod_num) {
	return svlib.UTF8ToString(svlib._sv_get_module_name(slot, mod_num));
}
function sv_get_module_xy(slot, mod_num) {
	return svlib._sv_get_module_xy(slot, mod_num);
}
function sv_get_module_color(slot, mod_num) {
	return svlib._sv_get_module_color(slot, mod_num);
}
function sv_get_module_finetune(slot, mod_num) {
	return svlib._sv_get_module_finetune(slot, mod_num);
}
function sv_get_module_scope2(slot, mod_num, channel, dest_buf_int16, samples_to_read) {
...
function sv_module_curve(slot, mod_num, curve_num, buf_float32, len, w) {
...
function sv_get_number_of_module_ctls(slot, mod_num) {
	return svlib._sv_get_number_of_module_ctls(slot, mod_num);
}
function sv_get_module_ctl_name(slot, mod_num, ctl_num) {
	return svlib.UTF8ToString(svlib._sv_get_module_ctl_name(slot, mod_num, ctl_num));
}
function sv_get_module_ctl_value(slot, mod_num, ctl_num, scaled) {
	return svlib._sv_get_module_ctl_value(slot, mod_num, ctl_num, scaled);
}
function sv_get_number_of_patterns(slot) {
...
function sv_get_pattern_x(slot, pat_num) {
	return svlib._sv_get_pattern_x(slot, pat_num);
}
function sv_get_pattern_y(slot, pat_num) {
	return svlib._sv_get_pattern_y(slot, pat_num);
}
function sv_get_pattern_tracks(slot, pat_num) {
	return svlib._sv_get_pattern_tracks(slot, pat_num);
}
function sv_get_pattern_lines(slot, pat_num) {
	return svlib._sv_get_pattern_lines(slot, pat_num);
}
function sv_get_pattern_name(slot, pat_num) {
	return svlib.UTF8ToString(svlib._sv_get_pattern_name(slot, pat_num));
}
function sv_get_pattern_data(slot, pat_num) {
	//return value: UInt8Array; 8 bytes per event in format: NN VV MM MM EE CC YY XX
	var rv = null;
...
function sv_set_pattern_event(slot, pat_num, track, line, nn, vv, mm, ccee, xxyy) {
	return svlib._sv_set_pattern_event(slot, pat_num, track, line, nn, vv, mm, ccee, xxyy);
}
function sv_get_pattern_event(slot, pat_num, track, column) {
	return svlib._sv_get_pattern_event(slot, pat_num, track, line, column);
}
function sv_pattern_mute(slot, pat_num, mute) {
	return svlib._sv_pattern_mute(slot, pat_num, mute);
} //USE LOCK/UNLOCK!
function sv_get_ticks() {
	return svlib._sv_get_ticks();
}
function sv_get_ticks_per_second() {
	return svlib._sv_get_ticks_per_second();
}
function sv_get_log(size) {
